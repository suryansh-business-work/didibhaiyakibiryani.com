...
/**
 * Single MUI theme for the whole survey app, mirroring the CSS custom
 * properties in styles.css so MUI components match the existing dark-gold
 * design. Provided once at the app root (main.tsx) so every component inherits
 * it.
 */
